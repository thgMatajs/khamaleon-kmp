 ...
 */
package io.gentalha.code.khamaleon.colors.dynamiccolor
...
import io.gentalha.code.khamaleon.colors.scheme.Variant
...
internal class MaterialDynamicColors(
    private val isExtendedFidelity: Boolean = true,
