...
import io.gentalha.code.khamaleon.colors.utils.ColorUtils.whitePointD65
import io.gentalha.code.khamaleon.colors.utils.ColorUtils.yFromLstar
import io.gentalha.code.khamaleon.colors.utils.MathUtils.lerp
...
internal class ViewingConditions private constructor(
    ...
    companion object {
         ...
         */
        private fun defaultWithBackgroundLstar(lstar: Double): ViewingConditions = make(
